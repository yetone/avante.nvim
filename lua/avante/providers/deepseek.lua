...
---@field choices? DeepSeekResponseChoice[] | DeepSeekResponseChoiceComplete[]
---@field usage {prompt_tokens: integer, completion_tokens: integer, total_tokens: integer}
---
---@class DeepSeekResponseChoice
---@field index integer
---@field delta DeepSeekMessage
---@field logprobs? integer
---@field finish_reason? "stop" | "length"
---
---@class DeepSeekResponseChoiceComplete
---@field message DeepSeekMessage
...
M.api_key_name = "SILICONFLOW_API_KEY"
